...
class jacobian_t {
    ...
    __device__ inline operator const void*() const { return this; }
...
public:
     ...
     */
    __device__ static void dadd(jacobian_t& out, const jacobian_t& p1,
                                      const jacobian_t& p2)
    {
    ...
    __device__ inline void dadd(const jacobian_t& p2)
    {   dadd(*this, *this, p2);   }
     ...
     * infinity by virtue of Z3 = (U2-U1)*zz = H*zz = 0*zz == 0.
     */
    __device__ static void dadd(jacobian_t& out, const jacobian_t& p1, const affine_t& p2)
    {
     ...
     */
    __device__ static void add(jacobian_t& out, const jacobian_t& p1, const jacobian_t& p2)
    {
        jacobian_t p3;
     ...
     * and |p2| as X==Y==0.
     */
    __device__ static void add(jacobian_t& out, const jacobian_t& p1, const affine_t& p2)
    {
        jacobian_t p3;
     ...
     */
    __device__ static void dbl(jacobian_t& p3, const jacobian_t& p1)
    {
        field_t A, B, C;
    ...
    __device__ inline void dbl() { dbl(*this, *this); }
